...
plt.tight_layout()
plt.savefig(join(figure_path,'between_within_delta_aic.png'),dpi=300)
plt.clf()
plt.axhline(0,color='k')
...
plt.xticks([1,6,11],[2010,2015,2020])
plt.tight_layout()
plt.savefig(join(figure_path,'between_within_delta_r2.png'),dpi=300)
...
plt.xticks([1,6,11],[2010,2015,2020])
plt.tight_layout()
plt.savefig(join(figure_path,'between_within_delta_aic_full.png'),dpi=300)
plt.clf()
plt.axhline(0,color='k')
...
plt.xticks([1,6,11],[2010,2015,2020])
plt.tight_layout()
plt.savefig(join(figure_path,'between_within_delta_r2_full.png'),dpi=300)
